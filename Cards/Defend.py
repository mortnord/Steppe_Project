...
class Defend(Card):
    ...
    def usage(self, card_nr, x):
        ...
        Static_Data.get_list_of_people()[nr_dwarf_to_target].defend += self.value #Her legger vi til defend
        print("The dwarf has " + str(Static_Data.get_list_of_people()[nr_dwarf_to_target].defend) + " armor now")
