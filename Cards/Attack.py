...
class Attack(Card):
    ...
    def usage(self, card_nr, target_enemy,
        ...
        nr_dwarf.has_energy = nr_dwarf.use_energy(self.energy_required)  # og legger det i discard-pile lista
